				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p style="float:left;display:block"><b>Quantity:</b></p>
								<div class="cart_quantity_button" style="float:left;display:block;margin:-2px 0px 0px 20px">
									<a class="cart_quantity_up" href=""> + </a>
									<input class="cart_quantity_input" type="text" name="quantity" value="1" autocomplete="off" size="2">
									<a class="cart_quantity_down" href=""> - </a>
								</div>
								<div style="margin: 44px 0px -31px 0px;float:left;">
									<a href="">
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12" style="margin-top:40px">
							<h2 class="title text-center">Total Reviews (5)</h2>
						</div>
